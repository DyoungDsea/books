						...
						<div class="block-content">
							...
							<div class="carousel-box owl-wrapper">
								...
								<div class="title-section">
									<div class="row">
									<div class="col-md-9">
									<h1 style="font-size:24px"><span class="world">ADMIN PANEL &raquo; MANAGE ADVERTS</span></h1>
									</div>
									<div class="col-md-3" align="right">
									<a href="admin_manage_advert_new" class="btn-primary btn">+ Post New Advert</a>
									</div>
									</div>
								</div>
...
$query= "SELECT * FROM manage_adverts where dstatus like '%$dstatus%' and idefault='no' ORDER BY id DESC";
$result = mysqli_query($conn,$query);
		...
		echo '<table class="table no-margin table-hover">';
                      ...
                      while($row = $result->fetch_assoc()){
						...
						$mydurl=$row['durl'];
                         ...
                         echo' <tr>';
						 if($mycat=='730x90') { 
                         echo'<td width="85%"><img src="'.$row['dpic'].'" width=350 align=left> &nbsp; URL: '.$mydurl.'</td>';
						 }
						 else {
						 echo'<td width="85%"><img src="'.$row['dpic'].'" height=100 align=left> &nbsp; URL: '.$mydurl.'</td>';
						 }
                         echo'<td width="15%">';
                         ...
                         echo'<div class="btn-group">
						  ...
						  <ul class="dropdown-menu" role="menu">';
						   ...
						   ?>
                           <li><a href=advert_delete?id=<?php echo $row["id"]; ?>  onClick="return confirm('Are you sure that you want to delete this advert completely ?')">Delete</a></li>
						   <?php
                           echo'</ul></div>';
                           echo'</td>';
                           echo'</tr>';
					 ...
					 echo '<center> <span style="font-size: 1.2em; font-weight: 600; color: #3782b9">No advert posted yet!</span></center><br><br><br><br>';
					}
