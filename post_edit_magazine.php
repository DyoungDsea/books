						...
						<div class="block-content">
							...
							<div class="carousel-box owl-wrapper">
								...
								<div class="title-section">
									<h1 style="font-size:24px"><span class="world">Admin Panel &raquo; Edit Magazine Upload</span></h1>
								</div>
...
?>
			...
			<form name="frmMain" action="admin_manage_magazine_update" method="POST" enctype="multipart/form-data">
						<input type="hidden" name="id" value="<?php echo $post; ?>" />
						<input type="hidden" name="dcat" value="Magazine">
						
						<div class="form-group">
                            <div class="input-group col-xs-12">
                                <b>Magazine Title*</b>
								<input type="text" name="dtitle" class="form-control" placeholder="Magazine Title" required="required" value="<?php echo $row['dtitle']; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group col-xs-12">
                               <b> Short Description*</b>
								<textarea name="dcontent" id="editor1" class="form-control" placeholder="Description..." rows="7" required="required"><?php echo stripslashes($row['dcontent']); ?></textarea>
								<script>
						...
						<div class="form-group">
                            <div class="input-group col-xs-8">
                                <b>External URL*</b>
								<input type="text" name="dpic2" class="form-control" value="<?php echo $row['dpic2']; ?>" required />
                            </div>
                        </div>
                    ...
                    <div class="modal-footer" style="margin-top:20px;">
                        ...
                        <input type="submit" class="btn btn-primary" value=" UPDATE Magazine " >
