						...
						<div class="block-content">
							...
							<div class="carousel-box owl-wrapper">
								...
								<div class="title-section">
									<h1 style="font-size:24px"><span class="world">Admin Panel &raquo; New Audio Book </span></h1>
								</div>
...
<!-- The Post textarea panel   -->
			...
			<form name="frmMain" action="admin_manage_audiobook_insert" method="POST" enctype="multipart/form-data">
				<input type="hidden" name="dstatus" value="running">		
						...
						<div class="form-group">
                            <div class="input-group col-xs-10">
                                <b>Audio URL*</b>
								<input type="text" name="durl" class="form-control" placeholder="Audio URL" required="required" />
                            </div>
                        </div>
                    ...
                    <div class="modal-footer" style="margin-top:20px;">
                        ...
                        <input type="submit" class="btn btn-primary" value=" UPLOAD UPLOAD AUDIO BOOK " >
