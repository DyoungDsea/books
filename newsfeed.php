					<!-- article box -->
							<div class="article-box">
								...
								$next = $eu + $limit;										
									...
									$query= "SELECT * FROM manage_blog where dcat='$dcategory' and ispublished='yes' order by id desc limit $eu, $limit";
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="post-content">
												...
												<p><?php echo substr(stripslashes(nl2br($row['dpreview'])), 0, 200); ?>...</p>
