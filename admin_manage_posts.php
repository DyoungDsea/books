...
$query= "SELECT * FROM manage_blog where dcat like '%$dcat%' and dtitle like '%$search%' ORDER BY id DESC limit $eu, $limit";
$result = mysqli_query($conn,$query);
                      ...
                      while($row = $result->fetch_assoc()){
                         ...
                         echo'<div class="btn-group">
						  ...
						  ?>
						   ...
						   <li><a href="publisher.php?item=<?php echo $row['id']; ?>&action=publish">Publish Post</a></li>
						   <?php } else { ?>
						   <li><a href="publisher.php?item=<?php echo $row['id']; ?>&action=unpublish">Unpublish Post</a></li>
						   <?php } ?>
							
						   <?php
                           echo'<li><a href=admin_view_post_details?id=' . $row["id"] .'>'.'View Post Detail'.'</a></li>';
						   echo'<li><a href=admin_view_post_books?id=' . $row["id"] .'>'.'Manage Books'.'</a></li>';
