						...
						<div class="block-content">
							...
							<div class="carousel-box owl-wrapper">
								...
								<div class="title-section">
									<h1 style="font-size:24px"><span class="world">Admin Panel &raquo; Edit Music Upload</span></h1>
								</div>
...
?>
			...
			<form name="frmMain" action="admin_manage_music_update" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
                            <div class="input-group col-xs-12">
                                <b>Music Title*</b>
								<input type="text" name="dtitle" class="form-control" placeholder="Music Title" required="required" value="<?php echo $row['dtitle']; ?>" />
                            </div>
                        </div>
						...
						<div class="form-group">
                            <div class="input-group col-xs-8">
                                <b>Change Music File <small><i>(Mp3, etc.)</i></small></b>
