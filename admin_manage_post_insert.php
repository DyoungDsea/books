...
$sql_query="INSERT INTO manage_blog SET dcat='$dcat', dtitle='$dtitle', dpreview='$dpreview', dcontent='$dcontent', durl='$durl', dwritter='$dwritter', dwritter_bio='$dwritter_bio', dtime='$dtime', ssid='$ssid'";
