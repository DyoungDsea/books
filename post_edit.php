...
?>
			...
			<form name="frmMain" action="admin_manage_post_update" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
                            <div class="input-group col-xs-12">
                                <b>Post Title*</b>
								<input type="text" name="dtitle" class="form-control" placeholder="Post Title" required="required" value="<?php echo $row['dtitle']; ?>" />
                            </div>
                        </div>
						
						<div class="form-group">
                            <div class="input-group col-xs-12">
                                <b>Post Preview Text*</b>
								<textarea name="dpreview" class="form-control" required="required" rows="2"><?php echo $row['dpreview']; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group col-xs-12">
                               <b> Article Body*</b>
								<textarea name="dcontent" id="editor1" class="form-control" placeholder="Article..." rows="15" required="required"><?php echo stripslashes($row['dcontent']); ?></textarea>
								<script>
						...
						<div class="form-group">
                            <div class="input-group col-xs-11">
								...
								<input type="text" name="durl" class="form-control" placeholder="Enter Youtube URL" <?php if($dcat=='Featured Videos' or $dcat=='Audio Books') { ?> required="required" <?php } ?> value="<?php echo $row['durl']; ?>" />
                            </div>
                        </div>
						<?php } ?>
						...
						<div class="form-group">
                            <div class="input-group col-xs-11">
                                <b>Written By:</b>
								<input type="text" name="dwritter" class="form-control" value="<?php echo $row['dwritter']; ?>" required="required" />
                            </div>
                        </div>
						...
						<div class="form-group">
                            <div class="input-group col-xs-11">
                                <b>Writer's Bio:</b>
								<textarea name="dwritter_bio" class="form-control" required="required" rows="2"><?php echo $row['dwritter_bio']; ?></textarea>
                            </div>
                        </div>
