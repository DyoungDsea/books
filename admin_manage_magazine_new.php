						...
						<div class="block-content">
							...
							<div class="carousel-box owl-wrapper">
								...
								<div class="title-section">
									<h1 style="font-size:24px"><span class="world">Admin Panel &raquo; Upload New Magazine</span></h1>
								</div>
...
<!-- The Post textarea panel   -->
			...
			<form name="frmMain" action="admin_manage_magazine_insert" method="POST" enctype="multipart/form-data">
						<input type="hidden" name="dcat" value="Magazine">
						
						<div class="form-group">
                            <div class="input-group col-xs-12">
                                <b>Edition Title*</b>
								<input type="text" name="dtitle" class="form-control" placeholder="Title of Edition" required="required" />
                            </div>
                        </div>
						...
						<div class="form-group">
                            <div class="input-group col-xs-8">
                                <b>External URL* </b>
								<input type="text" name="dpic2" class="form-control" required="required" />
                            </div>
                        </div>
...
<!-- The End Post textarea panel -->
					...
					<div class="col-sm-4">
						...
						<div class="sidebar">
							...
							<p><a href="admin_manage_magazine" class="btn btn-primary btn-block"> <b>Manage Posts</b> </a></p>
							<hr>
