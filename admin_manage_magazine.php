...
<?php
include("conn.php");
$page_name="admin_manage_magazine"; 
  $start=$_GET['start'];// 
  if(!($start > 0)) { 
  $start = 0;
}
                      ...
                      while($row = $result->fetch_assoc()){
                         ...
                         echo'<div class="btn-group">
						  ...
						  <ul class="dropdown-menu" role="menu">';
                           ...
                           echo'<li><a href=admin_view_magazine_details?id=' . $row["id"] .'>'.'View Detail'.'</a></li>';
                           echo'<li><a href=post_edit_magazine?id=' . $row["id"].'>'.'Edit'.'</a></li>';
						   ?>
                           <li><a href=post_delete_magazine?id=<?php echo $row["id"]; ?>  onClick="return confirm('Are you sure that you want to delete this post completely ?')">Delete</a></li>
						   <?php
                           echo'</ul></div>';
                           echo'</td>';
                           echo'</tr>';
...
<!-- The End Post textarea panel -->
					...
					<div class="col-sm-4">
						...
						<div class="sidebar">
							...
							<p><a href="admin_manage_magazine_new" class="btn btn-primary btn-block"> <b>Upload New Magazine</b> </a></p>
							<hr>
