						...
						<div class="block-content">
							...
							<div class="carousel-box owl-wrapper">
								...
								<div class="title-section">
									<h1 style="font-size:24px"><span class="world">Admin Panel &raquo; Manage Featutred Books Article</span></h1>
								</div>
...
$query= "SELECT * FROM manage_features where dcat like '%$dcat%' and dtitle like '%$search%' ORDER BY id DESC limit $eu, $limit";
$result = mysqli_query($conn,$query);
                      ...
                      while($row = $result->fetch_assoc()){
                         ...
                         echo'<div class="btn-group">
						  ...
						  <ul class="dropdown-menu" role="menu">';
                           ...
                           echo'<li><a href=admin_view_feature_details?id=' . $row["id"] .'>'.'View Detail'.'</a></li>';
                           echo'<li><a href=post_edit_feature?id=' . $row["id"].'>'.'Edit'.'</a></li>';
						   echo'<li><a href=post_books?id=' . $row["id"].'>'.'Manage Books'.'</a></li>';
						   ?>
                           <li><a href=post_delete_feature?id=<?php echo $row["id"]; ?>  onClick="return confirm('Are you sure that you want to delete this post completely ?')">Delete</a></li>
						   <?php
                           echo'</ul></div>';
                           echo'</td>';
                           echo'</tr>';
...
<!-- The End Post textarea panel -->
					...
					<div class="col-sm-4">
						...
						<div class="sidebar">
							...
							<p><a href="admin_manage_books_new" class="btn btn-primary btn-block"> <b>New Post</b> </a></p>
							<hr>
