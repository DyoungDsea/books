						...
						<div class="block-content">
							...
							<div class="carousel-box owl-wrapper">
								...
								<div class="title-section">
									<h1 style="font-size:24px"><span class="world">LOGIN PANEL</span></h1>
								</div>
								...
								<div>
									...
									<form method="post" action="do_login" name="formx">
									...
									<div class="col-md-8">
									<p>
									<input type="submit" name="b1" class="btn btn-primary pull-right" value=" &nbsp;&nbsp;&nbsp;&nbsp; Login &nbsp;&nbsp;&nbsp;&nbsp; ">
									</p>
									</div>
									</div>
