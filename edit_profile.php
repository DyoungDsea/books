			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8">
						...
						<div class="block-content">
							...
							<div class="carousel-box owl-wrapper">
								...
								<div class="title-section">
									<h1 style="font-size:24px"><span class="world">Edit Profile</span></h1>
								</div>
						...
						<form method="post" action="profile_update" enctype="multipart/form-data" name="frm">
							...
							<div class="row">
								...
								<p>
								Full Name
								<input type="text" class="form-control" name="dname" value="<?php echo $full_name; ?>" required>
								</p>
								</div>
							</div>
							...
							<div class="row">
								...
								<p>
								Phone Number
								<input type="text" class="form-control" name="phone" value="<?php echo $mphone; ?>" required>
								</p>
								</div>
							</div>
							...
							<div class="row">
								...
								<p>
								Location
								<input type="text" class="form-control" name="dlocation" value="<?php echo $maddress; ?>" required>
								</p>
								</div>
							</div>
