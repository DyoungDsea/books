						...
						<div class="block-content">
							...
							<div class="carousel-box owl-wrapper">
								...
								<div class="title-section">
									<h1 style="font-size:24px"><span class="world">ADMIN PANEL &raquo; CHANGE PASSWORD</span></h1>
								</div>
							...
							<form method="post" action="admin_changepass_update" enctype="multipart/form-data" name="frm">
